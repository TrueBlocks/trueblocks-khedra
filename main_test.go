...
func TestMain(t *testing.T) {
	...
	// os.Setenv("TB_KHEDRA_CHAINS_MAINNET_RPCS", "http://localhost:23456")
	// os.Setenv("TB_KHEDRA_CHAINS_MAINNET_CHAINID", "1")
	// os.Setenv("TB_KHEDRA_CHAINS_TESTNET_ENABLED", "false")
	// os.Setenv("TB_KHEDRA_CHAINS_TESTNET_RPCS", "junk")
	// os.Setenv("TB_KHEDRA_CHAINS_TESTNET_CHAINID", "101")
	...
	// os.Setenv("TB_KHEDRA_SERVICES_IPFS_PORT", "100000")
	// os.Setenv("TB_KHEDRA_SERVICES_MONITOR_BATCHSIZE", "100000")
	// os.Setenv("TB_KHEDRA_SERVICES_MONITOR_ENABLED", "false")
	// os.Setenv("TB_KHEDRA_SERVICES_MONITOR_SLEEP", "100000")
	// os.Setenv("TB_KHEDRA_SERVICES_SCRAPER_BATCHSIZE", "100000")
	// os.Setenv("TB_KHEDRA_SERVICES_SCRAPER_ENABLED", "false")
	// os.Setenv("TB_KHEDRA_SERVICES_SCRAPER_PORT", "100000")
	...
	// os.Setenv("TB_KHEDRA_LOGGING_LEVEL", "junk")
