...
func TestGetEnvironmentKeys(t *testing.T) {
	testGetEnvKeys := func(t *testing.T) {
		...
		assert.ElementsMatch(t, []string{
			...
			"TB_KHEDRA_GENERAL_MONITORSFOLDER",
